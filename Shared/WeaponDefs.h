...
{ 
	...
	DDWORD m_dwExtraModelFlags[GUN_MAX_NUMBER] =
	{
		...
		/*GUN_MONOKNIFE_ID*/		FLAG_ENVIRONMENTMAP,
		/*GUN_COLT45_ID*/			FLAG_ENVIRONMENTMAP,
		/*GUN_SHOTGUN_ID*/			FLAG_ENVIRONMENTMAP,
		/*GUN_ASSAULTRIFLE_ID*/		0,
		/*GUN_ENERGYGRENADE_ID*/	0,
		/*GUN_KATOGRENADE_ID*/		0,
		/*GUN_MAC10_ID*/			FLAG_ENVIRONMENTMAP,
		/*GUN_TOW_ID*/				0,
		/*NOT USED2*/				0,
		/*GUN_SQUEAKYTOY_ID*/		0,
		/*GUN_TANTO_ID*/			FLAG_ENVIRONMENTMAP
	};
